...
| chimp \#2 |   4.61| \[2.56, 8.61\]   |
| chimp \#3 |  -1.02| \[-1.56, -0.49\] |
| chimp \#4 |  -1.01| \[-1.57, -0.48\] |
| chimp \#5 |  -0.71| \[-1.24, -0.19\] |
| chimp \#6 |   0.23| \[-0.29, 0.76\]  |
| chimp \#7 |   1.76| \[1.07, 2.54\]   |
...
```
    ...
    ##      <dbl>     <dbl> <dbl> <dbl> <fct>    
    ## 1    0.980   0.0199  0.928 1.000 0/0      
    ## 2    0.991   0.00966 0.965 1.000 1/0      
    ## 3    0.980   0.0199  0.928 1.000 0/1      
    ## 4    0.990   0.0110  0.960 1.000 1/1
...
```
    ...
    ## Observations: 16,000
    ## Variables: 12
    ## $ b_Intercept               <dbl> -0.1336474, -0.6771235, -0.3658357, ...
    ## $ b_prosoc_left             <dbl> 0.9856597, 1.0404633, 1.1651535, 0.6...
    ## $ `b_prosoc_left:condition` <dbl> -0.232279566, -0.222004221, -0.44857...
    ## $ sd_actor__Intercept       <dbl> 2.615268, 2.897054, 3.102405, 2.2756...
    ## $ `r_actor[1,Intercept]`    <dbl> -0.37758479, -0.18974724, -0.6016706...
    ## $ `r_actor[2,Intercept]`    <dbl> 4.291255, 5.050088, 6.534572, 2.0749...
    ## $ `r_actor[3,Intercept]`    <dbl> -0.3440608, -0.6698155, -0.8993668, ...
    ## $ `r_actor[4,Intercept]`    <dbl> -0.8275816, -0.8196072, -0.8826118, ...
    ## $ `r_actor[5,Intercept]`    <dbl> -1.12352364, -0.09608532, -0.5443052...
    ## $ `r_actor[6,Intercept]`    <dbl> 1.08729131, 0.41775510, 0.56603797, ...
    ## $ `r_actor[7,Intercept]`    <dbl> 2.1700794, 2.6159913, 2.0799654, 0.6...
    ## $ lp__                      <dbl> -287.6739, -280.1267, -278.3876, -28...
...
```
    ...
    ## 1 0/0        0.332  0.225  0.452   0.95 mean   qi       
    ## 2 1/0        0.528  0.380  0.672   0.95 mean   qi       
    ## 3 0/1        0.332  0.225  0.452   0.95 mean   qi       
    ## 4 1/1        0.495  0.350  0.639   0.95 mean   qi
...
```
    ...
    ##   key       m    ll    ul
    ##   <fct> <dbl> <dbl> <dbl>
    ## 1 0/0   0.592 0.346 0.825
    ## 2 1/0   0.747 0.544 0.916
    ## 3 0/1   0.592 0.346 0.825
    ## 4 1/1   0.725 0.509 0.906
...
```
    ...
    ##   condition     m     ll    ul
    ##   <fct>     <dbl>  <dbl> <dbl>
    ## 1 0/0       0.541 0.0704 0.962
    ## 2 1/0       0.657 0.135  0.981
    ## 3 0/1       0.541 0.0704 0.962
    ## 4 1/1       0.639 0.128  0.981
...
```
    ...
    ## 1    0.592     0.182 0.346 0.825           0 0/0      
    ## 2    0.747     0.153 0.544 0.916           1 1/0      
    ## 3    0.592     0.182 0.346 0.825           0 0/1      
    ## 4    0.725     0.158 0.509 0.906           1 1/1
...
```
    ...
    ##   Estimate Est.Error    Q10   Q90 prosoc_left condition
    ##      <dbl>     <dbl>  <dbl> <dbl>       <dbl> <fct>    
    ## 1    0.560     0.328 0.0731 0.970           0 0/0      
    ## 2    0.670     0.308 0.155  0.987           1 1/0      
    ## 3    0.560     0.328 0.0731 0.970           0 0/1      
    ## 4    0.653     0.313 0.136  0.985           1 1/1
