...
tibble(mu   = 0,
  ...
  xlab(expression(paste(beta, " (i.e., shape)"))) +
...
```{r b9.1, echo = F}
# save(b9.1, file = "fits/b09.01.rda")
# rm(b9.1)
load("fits/b09.01.rda")
```
...
```{r, echo = F}
rm(d, alpha_per_beta, count_ways, p, sim_p, n_rep, p1, p2, ranked_d, subset_d, length_out, alpha, beta, lines, b9.1, post)
```
