...
```
    ...
    ##  num [1:10000] 0.804 0.6 0.415 0.548 0.482 ...
...
```
    ...
    ## Observations: 10,000
    ## Variables: 2
    ## $ samples       <dbl> 0.8508509, 0.4724725, 0.6616617, 0.5675676, 0.7107107, 0.7747748, 0.58158...
...
```
    ...
    ## 1 0.8438438 0.7047047 0.9309309    0.5 median        qi
...
```
    ...
    ##           y      ymin      ymax .width .point .interval
    ## 1 0.8438438 0.7047047 0.9309309   0.50 median        qi
    ## 2 0.8438438 0.5565566 0.9739740   0.80 median        qi
    ## 3 0.8438438 0.2722523 0.9989990   0.99 median        qi
...
```
    ...
    ##           y      ymin     ymax .width .point .interval
    ## 1 0.9563791 0.8428428 0.998999    0.5   mode       hdi
...
```
    ...
    ##   samples .lower .upper .width .point .interval
    ##     <dbl>  <dbl>  <dbl>  <dbl> <chr>  <chr>    
    ## 1   0.956  0.408  0.994   0.95 mode   qi
