...
## Population-Level Effects: 
##                    Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
## Intercept              9.23      0.14     8.95     9.50       2950 1.00
## rugged                -0.20      0.08    -0.36    -0.06       2976 1.00
## cont_africa           -1.95      0.23    -2.40    -1.49       2434 1.00
## rugged:cont_africa     0.39      0.13     0.13     0.65       2502 1.00
## 
## Family Specific Parameters: 
##       Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
## sigma     0.95      0.05     0.85     1.06       3859 1.00
## 
## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
## is a crude measure of effective sample size, and Rhat is the potential 
## scale reduction factor on split chains (at convergence, Rhat = 1).
...
![](08_files/figure-markdown_github/unnamed-chunk-32-1.png)
...
##  [4] tidybayes_1.0.4      brms_2.8.0           Rcpp_1.0.0          
...
## [16] ggplot2_3.1.0        tidyverse_1.2.1      hrbrthemes_0.6.0    
## 
...
##  [17] extrafont_0.17            knitr_1.20               
##  [19] shinythemes_1.1.1         jsonlite_1.5             
##  [21] broom_0.5.1               Rttf2pt1_1.3.7           
...
##  [71] lattice_0.20-35           rstantools_1.5.0         
