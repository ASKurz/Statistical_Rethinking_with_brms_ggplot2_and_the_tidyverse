...
Consider this model. It's taken from Bürkner's [-@Bürkner2020Multivariate] vignette, [*Estimating multivariate models with brms*](https://cran.r-project.org/package=brms/vignettes/brms_multivariate.html). It took about four minutes for my personal laptop to fit.
...
Four minutes isn't terribly long to wait, but still. I'd prefer to never have to wait for another four minutes, again. Sure, if I save my code in a document like this, I will always be able to fit the model again. But I can work smarter. Here I'll save my `b15.1` object outside of R with the `save()` function.
...
## sd(tarsus_Intercept)                     0.48      0.05     0.39     0.59 1.00      820     1273
## sd(back_Intercept)                       0.24      0.08     0.09     0.38 1.00      350      599
## cor(tarsus_Intercept,back_Intercept)    -0.53      0.24    -0.96    -0.06 1.00      582      775
## 
## ~fosternest (Number of levels: 104) 
##                                      Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sd(tarsus_Intercept)                     0.26      0.05     0.16     0.37 1.00      790     1486
## sd(back_Intercept)                       0.36      0.06     0.24     0.47 1.01      436     1013
## cor(tarsus_Intercept,back_Intercept)     0.69      0.20     0.23     0.98 1.01      294      534
## 
## Population-Level Effects: 
##                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## tarsus_Intercept    -0.41      0.07    -0.54    -0.27 1.00     1790     1441
## back_Intercept      -0.01      0.06    -0.14     0.11 1.00     3162     1889
## tarsus_sexMale       0.77      0.06     0.66     0.88 1.00     3622     1384
## tarsus_sexUNK        0.23      0.13    -0.03     0.48 1.00     3809     1727
## tarsus_hatchdate    -0.05      0.06    -0.17     0.06 1.00     1705     1748
## back_sexMale         0.01      0.07    -0.12     0.14 1.00     3655     1434
## back_sexUNK          0.15      0.15    -0.15     0.46 1.00     3793     1401
## back_hatchdate      -0.09      0.05    -0.20     0.01 1.00     2156     1546
## 
## Family Specific Parameters: 
##              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sigma_tarsus     0.76      0.02     0.72     0.80 1.00     2504     1659
## sigma_back       0.90      0.02     0.86     0.95 1.00     2467     1791
## 
## Residual Correlations: 
##                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## rescor(tarsus,back)    -0.05      0.04    -0.12     0.02 1.00     3181     1865
## 
...
## tarsus_Intercept         -0.407477157 0.06774079 -0.53636160 -0.27645328
## back_Intercept           -0.009858322 0.06818287 -0.14034242  0.11951987
## tarsus_sexMale            0.771016064 0.05713401  0.66167770  0.87772151
## tarsus_sexUNK             0.194975024 0.14829000 -0.09615388  0.49077344
## tarsus_hatchdate         -0.054718161 0.06616795 -0.18674591  0.07798450
## tarsus_sexMale:hatchdate  0.013362346 0.05756292 -0.09570965  0.13051447
## tarsus_sexUNK:hatchdate   0.064036842 0.12538175 -0.18641744  0.31022843
## back_sexMale              0.004697271 0.06940666 -0.13018649  0.14167466
## back_sexUNK               0.141885589 0.17316238 -0.19355567  0.48678427
## back_hatchdate           -0.051587053 0.06083319 -0.16817171  0.06586680
## back_sexMale:hatchdate   -0.077686158 0.06540361 -0.20900934  0.05137683
## back_sexUNK:hatchdate    -0.030728833 0.13995034 -0.29797029  0.24109788
```
...
## Population-Level Effects: 
##                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## tarsus_Intercept     0.00      0.03    -0.06     0.07 1.00     2256     1482
## back_Intercept       0.00      0.04    -0.07     0.07 1.00     2749     1637
## 
## Family Specific Parameters: 
##              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sigma_tarsus     1.00      0.03     0.96     1.05 1.01     2506     1659
## sigma_back       1.00      0.03     0.95     1.05 1.00     2371     1517
## 
## Residual Correlations: 
##                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## rescor(tarsus,back)    -0.03      0.04    -0.10     0.04 1.00     1852     1461
## 
## Samples were drawn using sampling(NUTS). For each parameter, Bulk_ESS
## and Tail_ESS are effective sample size measures, and Rhat is the potential
## scale reduction factor on split chains (at convergence, Rhat = 1).
...
##  [1] nlme_3.1-144         matrixStats_0.56.0   xts_0.12-0           threejs_0.3.3        rstan_2.19.3        
##  [6] tools_3.6.3          backports_1.1.9      R6_2.4.1             DT_0.13              colorspace_1.4-1    
## [11] tidyselect_1.1.0     gridExtra_2.3        prettyunits_1.1.1    processx_3.4.4       Brobdingnag_1.2-6   
## [16] emmeans_1.4.5        compiler_3.6.3       cli_2.0.2            shinyjs_1.1          sandwich_2.5-1      
## [21] labeling_0.3         colourpicker_1.0     bookdown_0.18        scales_1.1.1         dygraphs_1.1.1.6    
## [26] mvtnorm_1.1-0        ggridges_0.5.2       callr_3.4.4          stringr_1.4.0        digest_0.6.25       
## [31] StanHeaders_2.21.0-1 rmarkdown_2.1        base64enc_0.1-3      pkgconfig_2.0.3      htmltools_0.5.0     
## [36] fastmap_1.0.1        htmlwidgets_1.5.1    rlang_0.4.7          shiny_1.5.0          farver_2.0.3        
## [41] generics_0.0.2       zoo_1.8-7            crosstalk_1.1.0.1    gtools_3.8.2         dplyr_1.0.1         
## [46] inline_0.3.15        magrittr_1.5         loo_2.3.1            bayesplot_1.7.1      Matrix_1.2-18       
## [51] munsell_0.5.0        fansi_0.4.1          abind_1.4-5          lifecycle_0.2.0      stringi_1.4.6       
## [56] multcomp_1.4-13      yaml_2.2.1           MASS_7.3-51.5        pkgbuild_1.1.0       plyr_1.8.6          
## [61] grid_3.6.3           parallel_3.6.3       promises_1.1.1       crayon_1.3.4         miniUI_0.1.1.1      
## [66] lattice_0.20-38      splines_3.6.3        knitr_1.28           ps_1.3.4             pillar_1.4.6        
## [71] igraph_1.2.5         markdown_1.1         estimability_1.3     shinystan_2.5.0      reshape2_1.4.4      
## [76] codetools_0.2-16     stats4_3.6.3         rstantools_2.1.1     glue_1.4.2           evaluate_0.14       
## [81] vctrs_0.3.4          httpuv_1.5.4         gtable_0.3.0         purrr_0.3.4          assertthat_0.2.1    
## [86] ggplot2_3.3.2        xfun_0.13            mime_0.9             xtable_1.8-4         coda_0.19-3         
## [91] later_1.1.0.1        rsconnect_0.8.16     survival_3.1-12      tibble_3.0.3         shinythemes_1.1.2   
## [96] TH.data_1.0-10       ellipsis_0.3.1       bridgesampling_1.0-0
```
