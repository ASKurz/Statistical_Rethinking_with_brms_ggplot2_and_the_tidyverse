...
```{r}
bind_rows(
  mean_hdi(new_samples$p_grid, .width = c(.8, .95)),
...
```{r b3.1, echo = F}
# save(b3.1, file = "fits/b03.01.rda")
# rm(b3.1)
load("fits/b03.01.rda")
```
...
```{r, echo = F}
rm(n, n_success, n_trials, d, n_samples, samples, p1, p2, q_80, q_10_and_90, new_d, new_samples, point_estimates, make_loss, l, min_loss, n_draws, simulate_binom, tosses, b3.1, f)
```
