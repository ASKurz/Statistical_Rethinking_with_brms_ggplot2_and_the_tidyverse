...
Now's a good time to introduce Matthew Kay's [tidybayes package](https://mjskay.github.io/tidybayes/), which offers an [array of convenience functions](https://cran.r-project.org/package=tidybayes/vignettes/tidy-brms.html) for Bayesian models of the type we’ll be working with in this project.
