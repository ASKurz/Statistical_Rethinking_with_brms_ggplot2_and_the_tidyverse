...
rm(n, n_success, n_tirals, d, samples, q_80, q_10_and_90, point_estimates, make_loss, l, min_loss, n_draws, simulate_binom, probability, simulate_disaggregated_binom, disaggregated_samples, tosses, b3.1, fitted_samples)
```
