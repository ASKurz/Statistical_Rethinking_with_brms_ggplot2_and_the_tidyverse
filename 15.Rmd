...
```{r b15.1, cache = T, message = F, results = "hide"}
b15.1 <- 
  brm(data = BTdata,
      family = gaussian,
...
You can do this on any number of mediums, such as GitHub (e.g., [here](https://github.com/paul-buerkner/brms)), personal blogs [here](https://dilshersinghdhillon.netlify.com/post/multiple_comparison/)), on the Open Science Framework (e.g., [here](https://osf.io/dpzcb/)), in online books (e.g., [here](https://learningstatisticswithr.com/)), full-blown YouTube lectures (e.g., [here](https://www.youtube.com/watch?v=Vz71fglrgy0)), or even in brief Twitter gifs (e.g., [here](https://twitter.com/GuyProchilo/status/1207766623840604174)). I've found that just the possibility that others might look at my code makes it more likely I'll slow down, annotate, and try to use more consistent formatting. Hopefully it will benefit you, too.
