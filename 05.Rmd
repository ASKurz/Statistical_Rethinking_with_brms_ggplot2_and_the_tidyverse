...
```{r b5.4_supr, cache = T, message = F, warning = F}
brm(data = d, 
    family = gaussian,
    y ~ 1 + x_real + x_spur,
    prior = c(prior(normal(0, 10), class = Intercept),
...
But you can customize [these](https://ggobi.github.io/ggally/), too. E.g.,
...
```{r, echo = F}
rm(d, b5.1, nd, f, b5.2, b5.3, post, b5.4, r, text, b5.4b, n, p1, p2, p3, b5.5, dcc, b5.6, b5.7, rho, b5.0_both, b5.0_pos, b5.0_neg, b5.8, b5.9, b5.10, b5.11, b5.12, my_diag, my_lower, sim_coll, n_seed, n_rho, b5.13, b5.14, b5.15, b5.15b, b5.16, b5.16_alt)
```
