...
```
    ...
    ## [76] stats4_3.5.1              rstantools_1.5.0          glue_1.2.0               
    ## [79] evaluate_0.10.1           modelr_0.1.2              httpuv_1.4.4.2           
    ## [82] cellranger_1.1.0          gtable_0.2.0              assertthat_0.2.0         
    ## [85] mime_0.5                  xtable_1.8-2              broom_0.4.5              
    ## [88] coda_0.19-1               later_0.7.3               viridisLite_0.3.0        
