...
If you're still confused. Cool. This is just a preview. We'll start walking through fitting models in brms in @sec-A-Gaussian-model-of-height and we'll learn a lot about regression with the binomial likelihood in @sec-Prosocial-chimpanzees.
