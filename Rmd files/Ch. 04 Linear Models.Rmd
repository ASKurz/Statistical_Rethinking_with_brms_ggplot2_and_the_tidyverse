...
```{r, warning = F, echo = F}
rm(pos, growth, big, small, d, d2, sample_mu, sample_sigma, b4.1, b4.1_half_caucy, b4.2, post, b4.3, b4.4, N, dN, post10, post50, post150, post352, b10, b50, b150, b352, p10, p150, p50, p352, multiplot, mu_at_50, weight.seq, mu, muSummary, pred.height, b4.5, b4.6, b4.7, fitdquad, predquad, fitd_cub, pred_cub, fitd_line, pred_line, at)
```
