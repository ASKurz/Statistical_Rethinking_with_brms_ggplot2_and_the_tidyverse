...
* $\alpha \sim \text{Normal}(178, 100)$: `prior(normal(156, 100), class = Intercept`
...
```{r b4.7, cache = T, message = F, warning = F}
b4.7 <- 
  brm(data = d, family = gaussian,
      height ~ 1 + weight_s,
      prior = c(prior(normal(178, 100), class = Intercept),
...
```{r, warning = F, echo = F}
rm(pos, growth, big, small, n_points, d, d2, n, d_grid, grid_function, d_grid_samples, d3, b4.1, b4.1_half_cauchy, b4.2, post, b4.3, b4.4, N, b10, b50, b150, b352, post10, post50, post150, post352, p10, p150, p50, p352, multiplot, mu_at_50, mu, weight_seq, mu_summary, pred_height, b4.5, fitd_quad, pred_quad, b4.6, b4.7, fitd_cub, pred_cub, fitd_line, pred_line, at)
```
