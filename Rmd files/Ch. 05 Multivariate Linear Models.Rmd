...
```{r, echo = F}
rm(d, b5.1, nd, fitd5.1, b5.2, fitd5.2, b5.3, b5.4, fitd54, df54, res54, b5.4.1, df541, pred53.a, fitd53.a, pred53.b, fitd53.b, res53, pred53, N)
```
...
```{r, echo = F}
rm(d, b5.5, dcc, nd, dffitted.a, b5.6, dffitted.b, b5.7, dffitted.c, dffitted.d, N, rho, b5.O.both, b5.O.pos, b5.O.neg)
```
...
rm(d, N, b5.8, post, b5.9, b5.10, b5.11, b5.12, 
   my_diag, my_lower, sim.coll, rep.sim.coll, b5.13, b5.14)
```
