...
If you are new to making custom functions in R, you might check out [Chapter 19 in *R4DS*](https://r4ds.had.co.nz/functions.html) or [Chapter 14 in *R programming for data science*](https://bookdown.org/rdpeng/rprogdatascience/functions.html) [@pengProgrammingDataScience2019].
...
And as we'll learn much later in the project, the $\operatorname{Uniform}(0, 1)$ distribution is special in that we can also express it as the beta distribution for which $\alpha = 1 \text{ and } \beta = 1$. E.g.,
