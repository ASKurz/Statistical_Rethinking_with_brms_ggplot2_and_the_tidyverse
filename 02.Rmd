...
Gelman and Loken wrote a [great paper by this name](https://stat.columbia.edu/~gelman/research/unpublished/p_hacking.pdf).
...
If you’re new to making your own R functions, check out [Chapter 19](https://r4ds.had.co.nz/functions.html) of *R4DS* or [Chapter 14](https://bookdown.org/rdpeng/rprogdatascience/functions.html) of *R Programming for Data Science*.
