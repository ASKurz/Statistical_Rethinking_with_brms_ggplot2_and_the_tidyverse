...
* discussions ([8.3.2][Estimation.]) on the new `Bulk_ESS` and `Tail_ESS` summaries of HMC effective sample size [@vehtariRanknormalizationFoldingLocalization2019],
