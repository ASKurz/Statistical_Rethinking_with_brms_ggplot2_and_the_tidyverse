...
f_b14.3 %>% 
  ggplot(aes(x = neocortex,
             y = Estimate.kcal)) +
  geom_smooth(aes(ymin = Q2.5.kcal, ymax = Q97.5.kcal),
              stat = "identity",
...
```{r, echo = F, eval = F}
rm(p_pancake, take_sample, sim_pancake, n_sim, d, color, dlist, inits, inits_list, b14.1_se, b14.1_mi, data_error, b14.1b, nd, fitd_error, fitd_no_error, color_y, color_r, b14.2_se, b14.2_mi, color_p, data_list, b_model, b14.3, b14.3cc, f_b14.3, f_b14.3_mi, b14.4, f_b14.4, f_b14.4_mi, spank, b14.5, b14.6, label, b14.7)
```
