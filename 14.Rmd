...
```{r b14.1_se, echo = F}
# save(b14.1_se, file = "fits/b14.01_se.rda")
# save(b14.1_mi, file = "fits/b14.01_mi.rda")
# rm(b14.1_se)
# rm(b14.1_mi)
load("fits/b14.01_se.rda")
load("fits/b14.01_mi.rda")
```
...
```{r b14.1b, echo = F}
# save(b14.1b, file = "fits/b14.01b.rda")
# rm(b14.1b)
load("fits/b14.01b.rda")
```
...
```{r b14.2_se, echo = F}
# save(b14.2_se, file = "fits/b14.02_se.rda")
# save(b14.2_mi, file = "fits/b14.02_mi.rda")
# rm(b14.2_se)
# rm(b14.2_mi)
load("fits/b14.02_se.rda")
load("fits/b14.02_mi.rda")
```
...
```{r b14.3, echo = F}
# save(b14.3, file = "fits/b14.03.rda")
# rm(b14.3)
load("fits/b14.03.rda")
```
...
```{r b14.3cc, echo = F}
# save(b14.3cc, file = "fits/b14.03cc.rda")
# rm(b14.3cc)
load("fits/b14.03cc.rda")
```
...
```{r b14.4, echo = F}
# save(b14.4, file = "fits/b14.04.rda")
# rm(b14.4)
load("fits/b14.04.rda")
```
...
```{r b14.5, echo = F}
# save(b14.5, file = "fits/b14.05.rda")
# rm(b14.5)
load("fits/b14.05.rda")
```
...
```{r b14.6, echo = F}
# save(b14.6, file = "fits/b14.06.rda")
# rm(b14.6)
load("fits/b14.06.rda")
```
...
```{r b14.7, echo = F}
# save(b14.7, file = "fits/b14.07.rda")
# rm(b14.7)
load("fits/b14.07.rda")
```
...
```{r, echo = F}
rm(p_pancake, take_sample, sim_pancake, n_sim, d, theme_black, color, b14.1_se, b14.1_mi, data_error, p1, b14.1b, nd, f_error, f_no_error, color_y, color_r, p2, b14.2_se, b14.2_mi, color_p, data_list, b_model, b14.3, b14.3cc, f_b14.3, f_b14.3_mi, b14.4, f_b14.4, f_b14.4_mi, spank, b14.5, b14.6, label, b14.7)
```
