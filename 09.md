...
As mentioned in the vignette, the brms default is to model the log of *σ*. But anyways,

> hat the log link effectively assumes is that the parameter’s value is the exponentiation of the linear model. Solving log(*σ*<sub>*i*</sub>)=*α* + *β**x*<sub>*i*</sub> for *σ*<sub>*i*</sub> yields the inverse link:
>
...
```
    ...
    ##  [1] gridExtra_2.3   ghibli_0.1.1    bindrcpp_0.2.2  forcats_0.3.0  
