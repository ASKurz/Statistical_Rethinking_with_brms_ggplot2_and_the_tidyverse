...
crossing(mu    = c(1, 5, 9),
  ...
  labs(title = "Gamma can take many shapes",
       subtitle = "(dotted vertical lines at the means)",
       x = "parameter space") +
