...
Note how we just peeked at the top and bottom two rows with the `c(1:2, 59:60)` part of the code, there.
...
```{r, warning = F, echo = F}
rm(d, b12.1, b12.2, post, invlogit, postMdn, b12.2.e, a, sigma, n_ponds, dsim, b12.3, p_partpool, dfline, two_gaussians, b12.4, b12.5, l.b12.4, l.b12.5, nd, chimp, chimp_2_fitted, chimp_2_d, my_fitted, chimp_5_my_fitted, chimp_5_d, post_average_actor, ran_ef, fix_ef, ran_and_fix_ef, marginal_effects, p1, p2, p3, b12.6, pred_12.6)
```