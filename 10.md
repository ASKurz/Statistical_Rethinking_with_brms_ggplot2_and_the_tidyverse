...
```
    ...
    ##            Estimate Est.Error      Q2.5     Q97.5
    ## Intercept 0.5791433 0.5229363 0.5348587 0.6221902
...
```
    ...
    ## b10.2         680.41 9.37
    ## b10.3         682.37 9.40
    ## b10.1 - b10.2   7.60 6.19
    ## b10.1 - b10.3   5.64 6.28
    ## b10.2 - b10.3  -1.95 0.75
...
```
    ...
    ##      b10.1      b10.2      b10.3 
    ## 0.01600369 0.71486433 0.26913198
...
```
    ...
    ## Intercept                 0.04      0.13    -0.20     0.29       3686 1.00
    ## prosoc_left               0.61      0.22     0.17     1.03       2606 1.00
    ## prosoc_left:condition    -0.10      0.26    -0.61     0.44       2595 1.00
    ## 
...
```
    ...
    ## Warning: There were 6 divergent transitions after warmup. Increasing adapt_delta above 0.9 may help.
    ...
    ## Population-Level Effects: 
    ##                       Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## factoractor1             -0.74      0.27    -1.26    -0.19       3158 1.00
    ## factoractor2             10.87      5.27     4.01    23.86       1694 1.00
    ## factoractor3             -1.05      0.30    -1.63    -0.48       2941 1.00
    ## factoractor4             -1.05      0.28    -1.61    -0.51       2751 1.00
    ## factoractor5             -0.74      0.27    -1.28    -0.22       3219 1.00
    ## factoractor6              0.22      0.26    -0.31     0.73       3047 1.00
    ## factoractor7              1.80      0.39     1.07     2.63       2930 1.00
    ## prosoc_left               0.84      0.27     0.34     1.37       2149 1.00
    ## prosoc_left:condition    -0.13      0.32    -0.76     0.47       2689 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## Observations: 4,000
    ## Variables: 10
    ## $ b_factoractor1            <dbl> -0.4721018, -0.7004720, -0.5091306, -1.2392740, -0.4559232, -...
    ## $ b_factoractor2            <dbl> 8.299315, 12.112532, 14.255475, 12.546183, 13.499979, 26.3564...
    ## $ b_factoractor3            <dbl> -0.9119794, -1.3395473, -0.5096325, -1.3772344, -0.5626288, -...
    ## $ b_factoractor4            <dbl> -1.0150061, -1.0966561, -0.9018135, -1.5402690, -0.5921934, -...
    ## $ b_factoractor5            <dbl> -0.63082169, -0.89257348, -0.56900262, -1.04259236, -0.349663...
    ## $ b_factoractor6            <dbl> 0.26227451, 0.02798829, 0.26720288, 0.06985497, 0.97262558, 0...
    ## $ b_factoractor7            <dbl> 2.0462009, 1.5148770, 2.0110545, 1.6613004, 2.1225820, 2.1499...
    ## $ b_prosoc_left             <dbl> 0.7798985, 0.8738546, 0.5714018, 1.2632763, 0.4797120, 0.2557...
    ## $ `b_prosoc_left:condition` <dbl> -0.236539114, 0.063553047, -0.306345880, -0.319088557, -0.362...
    ## $ lp__                      <dbl> -286.7025, -287.5290, -289.1237, -289.6835, -292.3984, -296.2...
...
```
    ...
    ## prosoc_left               0.61      0.22  0.17  1.03
    ## prosoc_left:condition    -0.10      0.26 -0.61  0.44
...
```
    ...
    ## prosoc_left               0.61      0.23  0.15  1.06
    ## prosoc_left:condition    -0.09      0.27 -0.63  0.42
...
\\text{logit} (p\_i) & = & \\alpha + \\beta\_1 \\text{male}\_i \\\\
\\alpha & \\sim & \\text{Normal} (0, 10) \\\\
\\beta\_1 & \\sim & \\text{Normal} (0, 10)
\\end{eqnarray}
$$
...
```
    ...
    ##                  WAIC     SE
    ## b10.6          988.59 326.37
    ## b10.7         1042.98 326.66
    ## b10.6 - b10.7  -54.39 164.24
...
```
    ...
    ##                          Count Pct.    Min. n_eff
    ## (-Inf, 0.5]   (good)     4     33.3%   375       
    ##  (0.5, 0.7]   (ok)       2     16.7%   354       
    ##    (0.7, 1]   (bad)      2     16.7%   22        
...
```
    ...
    ## $pareto_k
    ##  [1] 2.492119442 0.780964628 1.756730616 0.003467442 0.550912192 0.445163931 0.953787497 0.281227211
    ##  [9] 0.604055647 0.480915792 2.493503097 1.323993067
    ## 
    ## $n_eff
    ##  [1]    1.216620   30.108136    1.825310 3178.880671  702.089915  424.169713   21.755800 1218.297460
    ##  [9]  354.240676  374.576564    1.216146    3.619579
...
```
    ...
    ##                 LOOIC     SE
    ## b10.6          973.59 319.73
    ## b10.7         1021.82 317.67
    ## b10.6 - b10.7  -48.23 157.58
...
```
    ...
    ##                 LOOIC     SE
    ## b10.6         1034.80 343.34
    ## b10.7         1060.31 335.08
    ## b10.6 - b10.7  -25.50 167.42
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## Intercept    -0.83      0.05    -0.93    -0.73       2410 1.00
    ## male          0.61      0.06     0.49     0.74       2537 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ##        2.5%       50%     97.5%
    ## 1 0.1137317 0.1415004 0.1694995
...
\\begin{eqnarray}
n\_{\\text{admit}\_i} & \\sim & \\text{Binomial} (n\_i, p\_i) \\\\
\\text{logit} (p\_i) & = & \\alpha\_{\\text{dept}\_i} + \\beta\_1 \\text{male}\_i \\\\
...
```
    ...
    ##                 LOOIC     SE
    ## b10.6         1031.36 339.82
    ## b10.7         1064.76 338.23
    ## b10.8          123.19  27.17
    ## b10.9          139.90  31.88
    ## b10.6 - b10.7  -33.40 162.40
    ## b10.6 - b10.8  908.17 332.49
    ## b10.6 - b10.9  891.45 333.47
    ## b10.7 - b10.8  941.57 327.52
    ## b10.7 - b10.9  924.85 326.16
    ## b10.8 - b10.9  -16.71   8.54
...
```
    ...
    ##       Estimate Est.Error  Q2.5 Q97.5
    ## deptA     0.69      0.10  0.50  0.88
    ## deptB     0.65      0.11  0.42  0.87
    ## deptC    -0.58      0.08 -0.73 -0.43
    ## deptD    -0.61      0.09 -0.79 -0.44
    ## deptE    -1.06      0.10 -1.26 -0.87
    ## deptF    -2.63      0.16 -2.94 -2.34
    ## male     -0.10      0.08 -0.26  0.05
...
```
    ...
    ## b_deptA   0.69    0.00 0.10   0.50   0.62   0.69   0.76   0.88  1436    1
    ## b_deptB   0.65    0.00 0.11   0.42   0.57   0.65   0.72   0.87  1228    1
    ## b_deptC  -0.58    0.00 0.08  -0.73  -0.63  -0.58  -0.53  -0.43  1768    1
    ## b_deptD  -0.61    0.00 0.09  -0.79  -0.68  -0.61  -0.55  -0.44  2500    1
    ## b_deptE  -1.06    0.00 0.10  -1.26  -1.13  -1.06  -1.00  -0.87  2248    1
    ## b_deptF  -2.63    0.00 0.16  -2.94  -2.73  -2.63  -2.52  -2.34  2500    1
    ## b_male   -0.10    0.00 0.08  -0.26  -0.16  -0.11  -0.05   0.05  1163    1
    ## lp__    -70.70    0.06 1.92 -75.49 -71.66 -70.35 -69.32 -68.04  1138    1
    ## 
    ## Samples were drawn using NUTS(diag_e) at Thu Sep 20 12:07:38 2018.
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## Intercept    -5.46      4.19   -14.97     0.36        390 1.01
    ## x             8.22      4.19     2.42    17.79        396 1.01
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## Population-Level Effects: 
    ##                      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## Intercept                0.94      0.36     0.22     1.64       4013 1.00
    ## log_pop                  0.26      0.03     0.20     0.33       4187 1.00
    ## contact_high            -0.09      0.84    -1.73     1.57       2815 1.00
    ## log_pop:contact_high     0.04      0.09    -0.14     0.22       2829 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## b10.13          150.91 47.79
    ## b10.14          141.72 33.36
    ## b10.10 - b10.11   0.91  1.22
    ## b10.10 - b10.12  -4.26  7.90
    ## b10.10 - b10.13 -70.85 47.74
    ## b10.10 - b10.14 -61.66 34.78
...
```
    ...
    ## 0.37303031 0.58122733 0.04574236
...
```
    ...
    ## Population-Level Effects: 
    ##                        Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## Intercept                  3.31      0.09     3.13     3.48       6171 1.00
    ## log_pop_c                  0.26      0.04     0.19     0.33       6669 1.00
    ## contact_high               0.29      0.12     0.06     0.52       7002 1.00
    ## log_pop_c:contact_high     0.06      0.17    -0.28     0.39       7181 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## b_log_pop_c:contact_high  0.08 -0.20 -0.25  1.00
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## Intercept     0.17      0.16    -0.16     0.47       2387 1.00
    ## monastery    -0.89      0.30    -1.50    -0.33       2603 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## 1 lambda_old   1.2   0.89   1.49   0.89 mean   hdi      
...
```
    ...
    ## Population-Level Effects: 
    ##               Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## mu2_Intercept     0.30      0.13     0.04     0.58       1191 1.00
    ## mu3_Intercept     0.97      0.12     0.74     1.21       1090 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## Population-Level Effects: 
    ##                   Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## mu2_Intercept         1.85      0.58     0.76     2.99       2666 1.00
    ## mu3_Intercept         1.54      0.57     0.45     2.73       2576 1.00
    ## mu2_family_income    -3.95      1.09    -6.16    -1.90       3110 1.00
    ## mu3_family_income    -2.55      0.94    -4.47    -0.76       2974 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## Intercept    -0.45      0.03    -0.51    -0.39       1235 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## Population-Level Effects: 
    ##                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## admit_Intercept     4.99      0.02     4.94     5.03       2507 1.00
    ## rej_Intercept       5.44      0.02     5.41     5.48       2049 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## intercept     0.74      0.25     0.25     1.22       1032 1.00
    ## x            -1.60      0.53    -2.65    -0.57       1033 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
