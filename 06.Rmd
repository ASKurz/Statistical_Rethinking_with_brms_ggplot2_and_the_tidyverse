...
Did you notice how we used the formula $D_\text{KL} (p, q) = \sum_i p_i \log \Bigg ( \frac{p_i}{q_i} \Bigg )$ within `mutate()`?
...
t %>% 
  ...
  labs(x = expression(paste(italic(q)[1])),
...
Now we compute the "Bayesian deviance" (i.e., $\text{lppd}$), which follow the form
