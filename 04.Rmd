...
```{r b4.1_hc, cache = T, message = F, warning = F}
b4.1_hc <- 
...
```{r, warning = F, echo = F}
rm(pos, growth, samples, n_points, d, d2, n, d_grid, grid_function, d_grid_samples, d3, b4.1, b4.1_half_cauchy, b4.2, post, b4.3, b4.4, b4.3_010, b4.3_050, b4.3_150, b4.3_352, post010, post050, post150, post352, p1, p2, p3, p4, mu_at_50, mu, weight_seq, mu_summary, pred_height, b4.5, f, p, b4.6, b4.7, at)
```
