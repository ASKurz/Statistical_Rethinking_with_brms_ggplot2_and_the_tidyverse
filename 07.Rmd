...
The brms package includes the `conditional_effects()` (previously known as `marginal_effects()` until version 2.10.3; see [here](https://github.com/paul-buerkner/brms/issues/735)) function as a convenient way to look at simple effects and two-way interactions. Recall the simple univariable model, `b7.3`:
...
```{r, echo = F}
rm(d, dd, d.A0, d.A1, b7.1, b7.2, nd, f, b7.3, b7.4, b7.5, l, b7.5b, post, b7.6, b7.7, w, b7.8, b7.9, k, shade_seq, fig, d_factor, b7.4_factor, b7.5_factor, dt, ic)
```
